...
const { registerUser, getSponsorName, authUser, ForgotPassword, resetPassord, sendOtp, checkMobileNumber, checkEmail, checkSponsorId, sendMessage, getVideoLink } = require("../../controllers/publicControllers/index");
